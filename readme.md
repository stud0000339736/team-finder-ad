# TeamFinder
Платформа, на которой разработчики, дизайнеры и другие специалисты смогут находить единомышленников для совместной работы над pet-проектами. У зарегистрированных пользователей будет возможность размещать здесь идеи проектов, находить команду и откликаться на опубликованные предложения.

# Стек технологий
  - Django (5) + Python (3.12) - backend
  - HTML + CSS + JS - frontend
  - Docker - "разворот" проекта
...
# Автор проекта
Бордиков Алексей Владиславович + Яндекс практикум
<br>
Почта для связи: stud0000339736@study.utmn.ru


# P.S
Комментарии для ревьюера лежит в отдельном файле с названием `Комментарии_для_ревьюера.md`